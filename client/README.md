...
-DONE - User ID is typing
Next:
-!!!Add authentication
-Add database with friends/ delete chat history
-Add support for nicknames
-Add private messaging/ chat rooms
-Add support for images
-Style (React Bootstrap)
-Electron Desktop App 

LOGIN SCREEN: https://medium.com/technoetics/create-basic-login-forms-using-create-react-app-module-in-reactjs-511b9790dede
